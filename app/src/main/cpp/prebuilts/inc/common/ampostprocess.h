...
#define MEDIANCUT                           0x00
#define NEUQUANT                            0x01
#define WU									0x02
...
typedef struct __tag_mblitfx
{
	...
	MInt32	lBrightness;		//Value for brightness adjust, -128~127, 0 means adjust none
	MInt32	lContrast;			//Value for contrast adjust, -128~127, 0 means adjust none
	MInt32	lSaturation;		//Value for saturation adjust, -128~127, 0 means adjust none
...
MPP_IMPORT MRESULT MPProcess(MHandle hPP, MByte *ppDst[MPP_MAX_PLANES], MRECT *pDstRect, MInt32 pDstPitch[MPP_MAX_PLANES],
					MByte *ppSrc[MPP_MAX_PLANES], MInt32 pSrcPitch[MPP_MAX_PLANES]);

MPP_IMPORT MRESULT MPProcessEx(MHandle hPP, MByte *ppDst[MPP_MAX_PLANES], MPOINT* pDstPtrPos, MRECT *pDstRect, MInt32 pDstPitch[MPP_MAX_PLANES],
					MByte *ppSrc[MPP_MAX_PLANES], MInt32 pSrcPitch[MPP_MAX_PLANES]);
...
//add for gif
MHandle  AMQuant_CreatePalette(MDWord  type);
MRESULT  AMQuant_PaletteInit(MHandle hPalette, MByte *pSource, MInt32 lSourceLineBytes, MInt32 lWidth, MInt32 lHeight, MVoid *pPal, MHandle *pShareData);
MRESULT  AMQuant_PaletteInitMask(MHandle hPalette, MByte *pSource,MInt32 lSourceLineBytes, MByte *pMask,MInt32 lMaskLineBytes, MInt32 lWidth, MInt32 lHeight, MVoid *pPal, MHandle *pShareData, MBool *bTransparent);
MRESULT	 AMQuant_PaletteProcess(MHandle hPalette, MByte *pSource, MInt32 lSourceLineBytes, MInt32 lWidth, MInt32 lHeight, MDWord nClrs,  MVoid *pPal, MHandle pShareData);
MRESULT	 AMQuant_PaletteProcessMask(MHandle hPalette, MByte *pSource, MInt32 lSourceLineBytes, MInt32 lWidth, MInt32 lHeight, MDWord nClrs,  MVoid *pPal, MHandle pShareData, MByte* byTransparentIndex);
MRESULT	 AMQuant_GetPalette(MHandle hPalette, MByte *pSource, MInt32 lSourceLineBytes, MInt32 lWidth, MInt32 lHeight, MDWord nClrs,  MVoid *pPal);
MRESULT	 AMQuant_GetPaletteMask(MHandle hPalette, MByte *pSource, MInt32 lSourceLineBytes, MByte* pMask, MInt32 lMaskLineBytes , MInt32 lWidth, MInt32 lHeight,MDWord nClrs, MVoid *pPal, MByte* byTransparentIndex, MBool* bTransparent);
MRESULT	 AMQuant_Remapfloyd(MHandle hPalette, MByte *pSource, MInt32 lSourceLineBytes, MByte *pDest, MInt32 lDestLineBytes, MInt32 lWidth, MInt32 lHeight, MVoid *pPal);
MRESULT	 AMQuant_RemapfloydMask(MHandle hPalette, MByte *pSource, MInt32 lSourceLineBytes, MByte* pMask, MInt32 lMaskLineBytes ,MByte *pDest, MInt32 lDestLineBytes, MInt32 lWidth, MInt32 lHeight, MVoid *pPal);
MRESULT	 AMQuant_DestroyPalette(MHandle hPalette);
MRESULT  AMQuant_MMBD(MByte* pSrcPre, MByte* pSrcCur, MInt32 lSourceLineBytes,  MByte* pMask, MInt32 lMaskLineBytes, MInt32 lWidth, MInt32 lHeight);
#ifdef __cplusplus
}
#endif
